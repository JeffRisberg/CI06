<?php foreach($query as $idea): ?>
  <div class="idea">
    <div class="idea meta">
    	<div class="title">
    	  <h2 style="margin-left: 0px"><?php echo $idea->title; ?></h2>
    	</div>
      <div class="date">
...
<div id="comment">
   <?php $this->load->view('idea/comment'); ?>
   ...
   <?php echo form_open('idea/saveComment/' . $idea_id) ?>     
     <p>Title:<br />
