...
class Competition extends CI_Controller {
	...
	public function index() {
		...
		$data['posts'] = $this->post_m->get_all();
	...
	public function view($id)	{
		...
		$data['query'] = $this->post_m->get($id);
		$data['comments'] = $this->post_m->get_comments($id);
		$data['post_id'] = $id;
		$data['total_comments'] = $this->post_m->total_comments($id);
	...
	public function saveComment($post_id)	{
		...
		if ($this->post_m->get($post_id)) {
			foreach ($this->post_m->get($post_id) as $row)	{
				//set page title
